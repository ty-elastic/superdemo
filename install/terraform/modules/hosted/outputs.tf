...
output "ingest_url" {
  value       = length(ec_deployment.es_cluster) > 0 ? "https://${var.cluster_name}-${var.project}.ingest.us-central1.gcp.elastic-cloud.com" : null
}

output "fleet_url" {
  value       = length(ec_deployment.es_cluster) > 0 ? "https://${var.cluster_name}-${var.project}.fleet.us-central1.gcp.elastic-cloud.com" : null
}
